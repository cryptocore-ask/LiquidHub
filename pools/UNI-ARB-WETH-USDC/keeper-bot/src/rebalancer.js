...
class Rebalancer {
  ...
  _shouldRefreshForPlanError(error) {
    const text = this._errorText(error).toLowerCase();
    return ['stale', 'cache', 'oracle', 'twap', 'price', 'minout', 'too little received', 'partialfill', 'partial fill', 'cycle budget', 'reverse budget', 'use atomic', 'swapchunkabovecap', 'e38', 'e90', 'e91', 'e96', 'e93', 'e94']
